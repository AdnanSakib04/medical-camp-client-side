    ...
    return (
        <div>
            <div className="max-w-7xl px-8 mx-auto ">
                ...
                <div className=" bg-blue-300 shadow-lg border mt-40 mb-40 pb-8 rounded-3xl px-8 text-blue-950 ">
                    ...
                    <div className=" text-black  italic grid grid-cols-1 lg:grid-cols-2 gap-x-2 ">
                        <div className="bg-blue-200  border-4   mx-auto rounded-lg mt-4   ">
                        ...
                        <div className="bg-blue-200  border-4   mx-auto rounded-lg mt-4  lg:max-h-[160px] ">
