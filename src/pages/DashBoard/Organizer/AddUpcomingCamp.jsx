...
const AddUpcomingCamp = () => {
    ...
    try {
      ...
      if (selectedDateTime <= currentDateTime) {
        Swal.fire({
          icon: 'error',
          title: 'Oops...',
          text: 'Date and time is smaller than or equal to the current date and time',
        });
        return;
      }
      ...
      if (res.data.success) {
        ...
        const campRes = await axiosPublic.post('/add-upcoming-camp', campData);
  ...
  return (
    <div>
      <Helmet>
        <title>Care Sync | Add Upcoming Camp</title>
      </Helmet>
      <div className="max-w-7xl mx-auto mb-40">
        <div className="p-4 mt-8 rounded-3xl">
          <form onSubmit={handleSubmit(onSubmit)} className="md:w-1/2 mx-auto card-body bg-blue-300 rounded-3xl">
            <h1 className="text-4xl font-bold lg:text-5xl mt-8 text-center">Add Upcoming Camp</h1>
